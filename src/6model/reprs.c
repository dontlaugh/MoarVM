...
MVM_NO_RETURN static void die_no_attrs(struct MVMThreadContext *tc, const char *repr_name, const char *debug_name) MVM_NO_RETURN_ATTRIBUTE;
static void die_no_attrs(struct MVMThreadContext *tc, const char *repr_name, const char *debug_name) {
    MVM_exception_throw_adhoc(tc,
...
MVM_NO_RETURN static void die_no_pos(struct MVMThreadContext *tc, const char *repr_name, const char *debug_name) MVM_NO_RETURN_ATTRIBUTE;
static void die_no_pos(struct MVMThreadContext *tc, const char *repr_name, const char *debug_name) {
    MVM_exception_throw_adhoc(tc,
        "This representation (%s) does not support positional access (for type %s)", repr_name, debug_name);
}
MVM_NO_RETURN static void die_no_multidim(struct MVMThreadContext *tc, const char *repr_name, const char *debug_name) MVM_NO_RETURN_ATTRIBUTE;
static void die_no_multidim(struct MVMThreadContext *tc, const char *repr_name, const char *debug_name) {
    MVM_exception_throw_adhoc(tc,
...
void MVM_REPR_DEFAULT_POS_WRITE_BUF(struct MVMThreadContext *tc, MVMSTable *st, MVMObject *root,
                                      void *data, char *from, int64_t offset, uint64_t elems) {
    die_no_pos(tc, st->REPR->name, MVM_6model_get_stable_debug_name(tc, st));
}
int64_t MVM_REPR_DEFAULT_POS_READ_BUF(struct MVMThreadContext *tc, MVMSTable *st, MVMObject *root,
                                      void *data, int64_t offset, uint64_t elems) {
    die_no_pos(tc, st->REPR->name, MVM_6model_get_stable_debug_name(tc, st));
}
GCC_DIAG_ON(return-type)
...
MVM_NO_RETURN static void die_no_ass(struct MVMThreadContext *tc, const char *repr_name, const char *debug_name) MVM_NO_RETURN_ATTRIBUTE;
static void die_no_ass(struct MVMThreadContext *tc, const char *repr_name, const char *debug_name) {
    MVM_exception_throw_adhoc(tc,
...
static void register_repr(struct MVMThreadContext *tc, const MVMREPROps *repr, MVMString *name) {
