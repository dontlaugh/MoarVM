...
int64_t MVM_thread_id(MVMThreadContext *tc, MVMObject *thread);
int64_t MVM_thread_native_id(MVMThreadContext *tc, MVMObject *thread);
int64_t MVM_thread_current_os_thread_id(MVMThreadContext *tc);
void MVM_thread_yield(MVMThreadContext *tc);
MVMObject * MVM_thread_current(MVMThreadContext *tc);
int64_t MVM_thread_lock_count(MVMThreadContext *tc, MVMObject *thread);
