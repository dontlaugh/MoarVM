int32_t MVM_unicode_lookup_by_name(MVMThreadContext *tc, MVMString *name);
int64_t MVM_unicode_has_property_value(MVMThreadContext *tc, MVMGrapheme32 codepoint, int64_t property_code, int64_t property_value_code);
uint32_t MVM_unicode_get_case_change(MVMThreadContext *tc, MVMCodepoint codepoint, int32_t case_, const MVMCodepoint **result);
